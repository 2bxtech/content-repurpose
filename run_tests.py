...
class TestAutomationSuite:
    ...
    def generate_test_report(self):
        ...
        reports = {
            ...
            "Coverage Report": self.project_root
            / "tests"
            / "coverage_html"
            / "index.html",
    ...
    def print_summary(self):
        ...
        if self.test_results:
            ...
            print("🐳 Test Environment: Docker Compose")
            print("📊 Reports Available: Yes")
            ...
            if success:
                ...
                print("   Check the HTML report for detailed information.")
        else:
...
def build_pytest_args(args: argparse.Namespace) -> List[str]:
    ...
    pytest_args.extend(["--json-report", "--json-report-file=tests/report.json"])
...
def main():
    ...
    test_group.add_argument(
        "--quick", action="store_true", help="Run only fast tests (unit + integration)"
    )
    test_group.add_argument(
        "--full",
        action="store_true",
    ...
    # Environment options
    parser.add_argument(
        "--cleanup", action="store_true", help="Clean up test environment after run"
    )
    parser.add_argument(
        "--setup-only",
        action="store_true",
