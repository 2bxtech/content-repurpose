...
class TestAnthropicProvider:
    ...
    def test_anthropic_cost_estimation(self, anthropic_provider):
        ...
        cost_haiku = anthropic_provider.estimate_cost(1000, 500, "claude-3-haiku-20240307")
        
        # Test with Opus (should be most expensive)
        cost_opus = anthropic_provider.estimate_cost(1000, 500, "claude-3-opus-20240229")
...
class TestAIProviderManager:
    ...
    def test_usage_tracking(self, manager):
        ...
        # Track usage
        asyncio.run(manager._track_usage("mock", MagicMock(usage_metrics=usage_metrics), 1.0))
