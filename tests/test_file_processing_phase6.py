...
class TestFileProcessorPhase6:
    ...
    def test_file_type_validation(self, file_processor):
        ...
        file_processor._validate_file_type("test.txt", b"plain text content")  # Should not raise
        ...
        with pytest.raises(ValueError, match="Dangerous file signature"):
            file_processor._validate_file_type("test.pdf", b"MZ\x90\x00")  # PE signature
    ...
    def test_validate_file_type_method(self, file_processor):
        ...
        assert file_processor.validate_file_type("application/vnd.openxmlformats-officedocument.wordprocessingml.document", "test.docx") is True
        ...
        assert file_processor.validate_file_type("image/jpeg", "test.jpg") is False  # Not supported
