...
class ServiceDependencyGraph:
    ...
    DEPENDENCY_MAP = {
        ...
        TestCategory.INTEGRATION: ["postgres-integration", "redis-integration", "api-integration"],
        TestCategory.FULL_STACK: ["postgres-integration", "redis-integration", "api-integration", "celery-integration"],
        TestCategory.PERFORMANCE: ["postgres-integration", "redis-integration", "api-integration", "celery-integration"]
    }
    ...
    RESOURCE_PROFILES = {
        ...
        TestCategory.INTEGRATION: TestResourceProfile(
            ...
            max_memory_mb=512,
            required_services=["postgres-integration", "redis-integration", "api-integration"],
            parallel_limit=4,
            timeout_seconds=120
        ),
        TestCategory.FULL_STACK: TestResourceProfile(
            ...
            max_memory_mb=1024,
            required_services=["postgres-integration", "redis-integration", "api-integration", "celery-integration"],
            parallel_limit=2,
            timeout_seconds=300
        ),
...
class PhaseTestRunner:
    ...
    def run_all_phases(self, 
                      ...
                      parallel_phases: bool = False) -> bool:
...
def main():
    ...
    parser.add_argument("--discover", action="store_true", help="Discover and list available phases")
