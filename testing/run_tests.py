...
class BulletproofTestRunner:
    ...
    def run_quick_validation(self) -> bool:
        ...
        if all_passed:
            ...
            print("💡 Run full validation: python testing/run_tests.py --validate --fix")
    ...
    def _run_quick_validation(self) -> bool:
        ...
        return (
            self._quick_check_python() and
            self._quick_check_imports() and
            self._quick_check_docker()
        )
    ...
    def _quick_check_python(self) -> bool:
        ...
        return (
            ...
            str(self.project_root / "backend") in sys.path
        )
...
Examples:
    ...
    action_group.add_argument("--all", action="store_true", help="Run tests for all phases")
    action_group.add_argument("--validate", action="store_true", help="Comprehensive environment validation")
    action_group.add_argument("--quick-validate", action="store_true", help="Quick validation (fastest)")
    action_group.add_argument("--diagnose", action="store_true", help="Run comprehensive diagnostics")
    action_group.add_argument("--setup-dev", action="store_true", help="Setup new developer environment")
    ...
    # Framework options
    parser.add_argument("--no-docker", action="store_true", help="Skip Docker-based tests")
    ...
    try:
        if args.setup_dev:
            ...
            success = runner.diagnostics.run_comprehensive_diagnostics(auto_fix=args.fix)
