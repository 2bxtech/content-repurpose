...
class SecurityMiddleware(BaseHTTPMiddleware):
    ...
    def _is_security_rate_limited(self, client_ip: str) -> bool:
        ...
        violations_this_minute = self.security_violations[client_ip].get(current_minute, 0)
    ...
    async def _handle_security_violation(self, request: Request, exception: HTTPException):
...
class InputValidationMiddleware(BaseHTTPMiddleware):
    ...
    def _check_array_sizes(self, obj: Any, max_size: int = 1000) -> bool:
        ...
        if isinstance(obj, list):
            ...
            return any(self._check_array_sizes(value, max_size) for value in obj.values())
    ...
    def _contains_malicious_content(self, obj: Any) -> bool:
        ...
        if isinstance(obj, str):
            ...
            return any(self._contains_malicious_content(value) for value in obj.values())
        elif isinstance(obj, list):
