...
from app.models.auth import User, TokenData, DeviceInfo
...
class AuthService:
    ...
    # Rate limiting
    def check_rate_limit(self, request: Request, limit_type: str) -> tuple[bool, int, int]:
    ...
    # Session management
    def create_session(self, user_id: int, refresh_token: str, device_info: DeviceInfo) -> bool:
