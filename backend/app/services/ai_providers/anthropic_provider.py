...
from .base import (
    ...
    ModelCapability, AIProviderError, RateLimitError, 
    QuotaExceededError, InvalidAPIKeyError
)
...
class AnthropicProvider(BaseAIProvider):
    ...
    def _initialize_client(self):
        ...
        try:
            ...
            raise AIProviderError(f"Failed to initialize Anthropic client: {str(e)}", "anthropic")
        ...
        **kwargs
        ...
        try:
            ...
            if "rate_limit" in error_msg.lower():
                ...
                raise QuotaExceededError(f"Anthropic quota exceeded: {error_msg}", "anthropic")
            elif "invalid" in error_msg.lower() and "key" in error_msg.lower():
                raise InvalidAPIKeyError(f"Invalid Anthropic API key: {error_msg}", "anthropic")
            else:
