...
class Document(BaseModel, WorkspaceMixin):
    ...
    transformations = relationship("Transformation", back_populates="document", lazy="select")
    
    # Performance indexes
    __table_args__ = (
        Index("idx_documents_workspace_user_created", "workspace_id", "user_id", "created_at"),
